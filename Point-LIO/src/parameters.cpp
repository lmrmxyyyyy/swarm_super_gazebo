...
std::string lid_topic, imu_topic,relocal_odom_topic;
...
bool   scan_pub_en, scan_body_pub_en,dense_pub_en;
...
void readParameters(ros::NodeHandle &nh)
{
  ...
  nh.param<std::string>("common/relocal_odom_topic", relocal_odom_topic,"/relocal_odom_topic");
  ...
  nh.param<bool>("use_relocal_odom", use_relocal_odom, false);
