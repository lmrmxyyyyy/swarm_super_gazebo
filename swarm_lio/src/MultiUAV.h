...
public:
    ...
    // Create the configured teammate tracker directly, without trajectory matching.
    void InitializeDirectTeammateTracker(StatesGroup &state_in, StatesGroup &state_prop,
                                         const double &lidar_end_time);

    bool DirectTeammateAssignmentEnabled() const;
...
private:
    ...
    bool direct_teammate_assignment{false};
    V3D direct_teammate_translation{Zero3d};
    V3D direct_teammate_rotation_deg{Zero3d};
