...
#define GTSAM_VERSION_PATCH 1
#define GTSAM_VERSION_NUMERIC 40101
#define GTSAM_VERSION_STRING "4.1.1"

// Paths to example datasets distributed with GTSAM
#define GTSAM_SOURCE_TREE_DATASET_DIR "/tmp/gtsam-4.1.1/examples/Data"
